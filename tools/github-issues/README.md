...
An interactive CLI tool to create GitHub issues that adhere to the project's labeling standards. It guides you through selecting the correct Type, Area, Priority, and Size.
