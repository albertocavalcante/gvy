package com.github.albertocavalcante.gvy.jupyter.core.protocol
...
data class JupyterMessage(
    ...
    fun metadataToJson(): String = json.encodeToString(serializableMetadata())
    ...
    private fun serializableMetadata(): Map<String, kotlinx.serialization.json.JsonElement> =
        metadata.mapValues { (_, v) -> v.toJsonElement() }
