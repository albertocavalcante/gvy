package com.github.albertocavalcante.gvy.jupyter.core.zmq
...
class JupyterConnection(private val config: ConnectionFile, val signer: HmacSigner) : Closeable {
     ...
     */
    fun sendMessage(
        message: com.github.albertocavalcante.gvy.jupyter.core.protocol.JupyterMessage,
        socket: ZMQ.Socket = shellSocket,
    ) {
        val wireMessage = com.github.albertocavalcante.gvy.jupyter.core.zmq.WireMessage(
     ...
     */
    fun sendIOPubMessage(message: com.github.albertocavalcante.gvy.jupyter.core.protocol.JupyterMessage) {
