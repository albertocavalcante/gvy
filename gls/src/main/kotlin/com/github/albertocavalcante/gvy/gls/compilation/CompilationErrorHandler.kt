...
import com.github.albertocavalcante.gvy.gls.dsl.RangeBuilder
import com.github.albertocavalcante.gvy.gls.dsl.diagnostic
import com.github.albertocavalcante.gvy.gls.errors.GroovyLspException
import com.github.albertocavalcante.gvy.gls.errors.syntaxError
...
class CompilationErrorHandler {
    ...
    private fun handleUnexpected(e: Exception): CompilationResult {
        logger.error(e) { "Unexpected compilation error" }
