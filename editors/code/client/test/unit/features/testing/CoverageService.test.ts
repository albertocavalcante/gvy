...
describe('CoverageService', () => {
    ...
    beforeEach(() => {
        ...
        const module = proxyquire('../../../../../src/features/testing/CoverageService', {
            'vscode': vscodeMock,
            'fs': fsMock
        });
    ...
    it('should correctly create multiple branch coverage entries for cb/mb counts', async () => {
        ...
        // Mock finding report
        fsMock.existsSync.withArgs(reportPath).returns(true);
        // Mock finding source file
        fsMock.existsSync.withArgs('/workspace/src/main/groovy/com/example/MyClass.groovy').returns(true);
