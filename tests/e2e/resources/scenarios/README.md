...
| **Build Tools** | `gradle-hover-deps`, `jenkins-pipeline` | Build tool integration |

## Server Mode Migration

> **Note**: Scenarios are being migrated from `mode: stdio` to `mode: inProcess`
> for faster test execution. See the parent [README.md](../README.md) for details.
