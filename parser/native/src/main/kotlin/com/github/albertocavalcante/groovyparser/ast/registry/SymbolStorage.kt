...
class SymbolStorage {
    ...
    // NOTE: Variable declarations are stored as lists to avoid overwriting same-named entries.
    // This enables scope-aware resolution for parameters and local variables.
    val variableDeclarations = ConcurrentHashMap<URI, MutableMap<String, MutableList<Variable>>>()
    ...
    fun getStatistics(): Map<String, Int> = mapOf(
        "variables" to variableDeclarations.values.sumOf { variables ->
            variables.values.sumOf { it.size }
        },
