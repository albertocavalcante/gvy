...
class VisitorExpressionCoverageTest {
    ...
    fun `tracks StaticMethodCallExpression for static method invocations`() {
        ...
        // If generated, verify parent relationships. Either way, test validates parsing
        // succeeds and the visitor doesn't crash on this code pattern.
        ...
        val code = """
            ...
            class ComplexExpressions {
                def process(Object obj) {
                    def str = (String) obj
                    def num = 5
                    def negNum = -num  // UnaryMinusExpression requires variable, not literal
                    def posNum = +num  // UnaryPlusExpression requires variable, not literal
